...
(function ($, window, document, undefined) {
   ...
   * @todo সাপোর্ট for media queries by using `matchMedia` would be nice.
   * @public
   */
  ...
  Owl.prototype.registerEventHandlers = function () {
    if ($.সাপোর্ট.transition) {
      this.$stage.on(
        $.সাপোর্ট.transition.end + ".owl.core",
  ...
  Owl.prototype.onDragStart = function (event) {
    ...
    if (this.is("animating")) {
      $.সাপোর্ট.transform ? this.animate(stage.x) : this.$stage.stop();
  ...
  Owl.prototype.animate = function (coordinate) {
    ...
    if ($.সাপোর্ট.transform3d && $.সাপোর্ট.transition) {
      this.$stage.css({
  ...
  Video.prototype.fetch = function (target, item) {
    ...
    if (url) {
      ...
      if (id[3].indexOf("youtu") > -1) {
        ...
        throw new Error("Video URL not সাপোর্টed.");
      }
      id = id[6];
    } else {
...
(function ($, window, document, undefined) {
  ...
  Animate.prototype.swap = function () {
    ...
    if (!$.সাপোর্ট.animation || !$.সাপোর্ট.transition) {
      return;
    }
    ...
    if (outgoing) {
      ...
      previous
        .one($.সাপোর্ট.animation.end, clear)
        .css({ left: left + "px" })
    ...
    if (settings.dots) {
      ...
      if (settings.dotsData && difference !== 0) {
        ...
        this._controls.$absolute.append(
          new Array(difference + 1).join(this._s[0])
        );
      } else if (difference < 0) {
...
(function ($, window, document, undefined) {
  ...
  if (tests.csstransitions()) {
    /* jshint -W053 */
    $.সাপোর্ট.transition = new String(prefixed("transition"));
    $.সাপোর্ট.transition.end = events.transition.end[$.সাপোর্ট.transition];
  }

  if (tests.cssanimations()) {
    /* jshint -W053 */
    $.সাপোর্ট.animation = new String(prefixed("animation"));
    $.সাপোর্ট.animation.end = events.animation.end[$.সাপোর্ট.animation];
  }

  if (tests.csstransforms()) {
    /* jshint -W053 */
    $.সাপোর্ট.transform = new String(prefixed("transform"));
    $.সাপোর্ট.transform3d = tests.csstransforms3d();
  }
})(window.Zepto || window.jQuery, window, document);
