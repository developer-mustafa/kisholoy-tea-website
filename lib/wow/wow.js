      ...
      (function () {
        function MutationObserver() {
          ...
          if (typeof console !== "undefined" && console !== null) {
            console.warn("MutationObserver is not সাপোর্টed by your browser.");
            console.warn(
  ...
  var WOW = (function () {
    ...
    _createClass(WOW, [
      ...
      },
      {
        key: "sync",
        value: function sync() {
          if (MutationObserver.notসাপোর্টed) {
      ...
      },
      {
        ...
        value: function cacheAnimationName(box) {
          ...
          // box.dataset is not সাপোর্টed for SVG elements in Firefox
